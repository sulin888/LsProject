...
layui.config({
    base: '/Content/lib/cropper/' //layui自定义layui组件目录
}).define(['jquery','layer','cropper'],function (exports) {
    var $ = layui.jquery
        ,layer = layui.layer;
    var html = "<link rel=\"stylesheet\" href=\"/Content/lib/cropper/cropper.css\">\n" +
        ...
        "        </div>\n" +
        "        <div class=\"layui-form-mid layui-word-aux\">头像的尺寸限定120x140px,大小在50kb以内</div>\n" +
        "    </div>\n" +
        ...
        "            <div class=\"img-preview\" style=\"width:120px;height:140px;overflow:hidden\">\n" +
        "            </div>\n" +
        "        </div>\n" +
        "    </div>\n" +
        "    <div class=\"layui-row layui-col-space15\">\n" +
